...
- **Soporte eficiente de opciones (Cabeceras de extensión):** En lugar de incorporar campos opcionales dentro de la cabecera fija, se introduce el concepto de **cabeceras de extensión opcionales**. Si un paquete requiere funciones especiales, estas cabeceras se colocan justo después de la cabecera fija en un orden predefinido.
